...
F14_4A_2P_FOCUS_DIST_BONUS = 24.0       # BEAST: was 18.0 — lock onto the one enemy harder
F14_4A_2P_FOCUS_HAMMER_BONUS = 30.0     # BEAST: was 20.0
F14_4A_2P_FOCUS_MEGA_BONUS = 140        # BEAST: was 100
...
FWD_SIM_HORIZON = 9             # BEAST: was 7 — look further ahead
...
SEARCH_MAX_ACTIONS_TO_PICK_2P = 9  # BEAST: was 7 — evaluate more moves per turn
...
FLEET_INTENT_MIN_DROP = 6       # BEAST: was 8 — detect enemy launches sooner
...
F1B_EXPAND_BONUS = 6.0   # BEAST: was 3.0 — pounce HARD when enemy just launched


R1_RECAPTURE_PRIORITY_ENABLED = True
R1_RECAPTURE_HAMMER_BONUS = 12.0  # BEAST: was 8.0 — recapture lost planets immediately
...
SO1_STATIC_BONUS_2P = 3.5         # BEAST: was 2.179862 — static planets are safe, grab early
SO1_STATIC_BONUS_4P = 3.2         # BEAST: was 2.95474
...
MELIS_SANITY_THETA = 1.5  # BEAST: was 3.0 — allow more marginal but positive 2P actions
...
DEFENSE_OVERSEND = 1             
DEFENSE_OVERSEND_2P = 2    # BEAST: was 1 — send a bigger safety margin in 2P
...
TIEBREAK_EPS_FRAC = 0.007   # BEAST: was 0.005 — slightly larger bucket to break mirror-locks
TIEBREAK_EPS_MIN = 1.8            # BEAST: was 1.439234
...
VALUE_WEIGHT_2P = 6.5         # BEAST: was 4.86118 — production lead is everything in 2P
...
REACTIVE_EMIT_FRAC = 0.40           # BEAST: was 0.49629 — less paranoid, more aggressive
...
LAUNCH_BLACKOUT_TURNS = 8  # BEAST: was 10 — keep launching 2 turns longer into endgame
...
NEUTRAL_HARD_CAP_2P = 65          # BEAST: was 61 — grab a few more neutrals in 2P
NEUTRAL_WATCHLIST_MIN_DROP = 4    # BEAST: was 5 — notice wounded neutrals sooner
...
WEAKEST_TARGET_BONUS = 3.0       # BEAST: was 2.0 — more aggressively focus weak enemies
WEAKEST_TARGET_MIN_STEP = 50     # BEAST: was 60 — start earlier
...
LEADER_BASH_RATIO = 1.2     # BEAST: was 1.3 — target leader sooner
LEADER_BASH_BONUS = 6.0     # BEAST: was 4.0 — stronger incentive
LEADER_BASH_MIN_STEP = 50   # BEAST: was 60 — start bashing leader earlier
...
COALITION_MIN_PER_CONTRIBUTOR_2P = 10    # BEAST: was 15 — easier to form 2P coalitions
COALITION_MIN_PER_CONTRIBUTOR_4P = 5    
COALITION_MIN_TARGET_SHIPS = 20      


HAMMER_ENABLED = True
HAMMER_STOCKPILE_MIN = 40         # BEAST: was 50 — strike with smaller stockpile
HAMMER_TARGET_PROD_MIN = 2
HAMMER_PROD_SHARE_TRIGGER = 0.40
HAMMER_OVERKILL_RATIO = 1.25      # BEAST: was 1.30 — more efficient, fewer wasted ships
...
MEGA_HAMMER_4P_ONLY = False           # BEAST: was True — ENABLE 2P overwhelming strikes!
MEGA_HAMMER_SHIPS_MIN = 180           # BEAST: was 300 — lower threshold for 2P
MEGA_HAMMER_TARGET_GARRISON_MAX = 100 # BEAST: was 80 — attack more targets
...
MEGA_HAMMER_THRESHOLD_BY_PROD = {5: 140, 4: 170, 3: 210, 2: 260, 1: 320}  # BEAST: all reduced from {5:200,4:250,3:300,2:350,1:400}
...
MEGA_HAMMER_SHIPS_MIN_FRESH = 150          # BEAST: was 200 — freshly captured planets strike fast
...
ACCUMULATOR_4P_ONLY = False                  # BEAST: was True — ENABLE 2P stockpile building!
ACCUMULATOR_TURN_MIN = 10                    # BEAST: was 15 — start feeding earlier
ACCUMULATOR_LEAD_MIN_SHIPS = 80             # BEAST: was 100 — smaller lead threshold
ACCUMULATOR_LEAD_THREAT_RATIO = 0.5         
ACCUMULATOR_FEEDER_MIN_SURPLUS = 22         # BEAST: was 30 — feed with smaller surplus
...
BRAIN_LEAD_RESERVE_4P_ONLY = False            # BEAST: was True — PROTECT 2P lead stockpile!
...
BRAIN_LEAD_RESERVE_MIN_SHIPS = 140  # BEAST: was 200 — start protecting lead at lower threshold
...
MULTIPRONG_ENABLED = True  # BEAST: was False — UNLEASH THE DILEMMA CREATOR!
...
LATE_FLUSH_REMAINING_TURNS = 28  # BEAST: was 25 — trigger late-game earlier
LATE_FLUSH_OVERKILL_RATIO = 1.03      # BEAST: was 1.05 — near-zero waste in endgame
...
MODE_PARAMS = {
    "patient": {
        ...
        "expand_k_mid": 1,
        "expand_max_travel_mid": 14,
        "hammer_prod_share": 0.18,        # BEAST: was 0.2 — strike sooner
        "hammer_overkill": 1.25,          # BEAST: was 1.30 — more efficient
        "hammer_stockpile_min": 40,       # BEAST: was 50 — lower barrier
    },
    "opportunistic": {
        "expand_k_opening": 3,            
        "expand_max_travel_opening": 22,  
        ...
        "hammer_prod_share": 0.28,        # BEAST: was 0.35
        "hammer_overkill": 1.22,          # BEAST: was 1.30
        "hammer_stockpile_min": 40,       # BEAST: was 50
    },
    "pressure": {
        "expand_k_opening": 3,            
        "expand_max_travel_opening": 22,  
        ...
        "hammer_prod_share": 0.22,        # BEAST: was 0.30 — strike much sooner
        "hammer_overkill": 1.12,          # BEAST: was 1.20 — waste fewer ships
        "hammer_stockpile_min": 38,       # BEAST: was 50 — fire faster
    },
}
...
MODE_PARAMS_2P = {
    "patient": {
        "expand_k_opening": 6,            # BEAST: was 5
        "expand_max_travel_opening": 42,  # BEAST: was 35 — reach further for good planets
        "expand_k_mid": 5,                # BEAST: was 4
        "expand_max_travel_mid": 32,      # BEAST: was 28
        "hammer_prod_share": 0.18,        # BEAST: was 0.30 — hammer MUCH sooner
        "hammer_overkill": 1.10,          # BEAST: was 1.15
        "hammer_stockpile_min": 18,       # BEAST: was 25
    },
    "opportunistic": {
        "expand_k_opening": 6,
        "expand_max_travel_opening": 42,
        "expand_k_mid": 7,                # BEAST: was 6
        "expand_max_travel_mid": 35,      # BEAST: was 30
        "hammer_prod_share": 0.15,        # BEAST: was 0.28 — attack early
        "hammer_overkill": 1.08,          # BEAST: was 1.15
        "hammer_stockpile_min": 18,       # BEAST: was 25
    },
    "pressure": {
        "expand_k_opening": 6,            # BEAST: was 5
        "expand_max_travel_opening": 42,  # BEAST: was 35
        "expand_k_mid": 3,
        "expand_max_travel_mid": 58,      # BEAST: was 52 — reach enemy across map
        "hammer_prod_share": 0.10,        # BEAST: was 0.25 — ALWAYS HAMMERING
        "hammer_overkill": 1.05,          # BEAST: was 1.177 — near-minimal overkill
        "hammer_stockpile_min": 15,       # BEAST: was 25 — fire at first opportunity
    },
}
