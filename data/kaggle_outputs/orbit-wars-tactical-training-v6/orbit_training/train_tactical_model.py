...
WITH_MINE_NEW_AGENT_LINEUPS = (
    ("mine", "best"),
    ("mine", "intruder"),
)

WITHOUT_MINE_NEW_AGENT_LINEUPS = (
    ("best", "intruder"),
)

WITH_MINE_OPPORTUNITY_LINEUPS = (
    ("mine", "best"),
    ("mine", "intruder"),
    ("mine", "best", "intruder", "smith"),
    ("mine", "best", "intruder", "1200"),
    ("mine", "best", "intruder", "1039"),
)

WITHOUT_MINE_OPPORTUNITY_LINEUPS = (
    ("best", "intruder"),
    ("best", "smith"),
    ("intruder", "smith"),
    ("best", "1200"),
    ...
    ("best", "1039"),
    ("intruder", "1039"),
    ("best", "intruder", "smith", "1200"),
    ("best", "intruder", "smith", "1039"),
    ("best", "intruder", "1200", "1039"),
)
...
def lineup_for(category, index, preset="all"):
    if preset == "new-agents":
        choices = WITH_MINE_NEW_AGENT_LINEUPS if category == "with_mine" else WITHOUT_MINE_NEW_AGENT_LINEUPS
